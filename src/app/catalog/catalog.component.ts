...
export class CatalogComponent {
  ...
  private cartSvc = inject<CartService>(CartService)
  private productSvc = inject<ProductsService>(ProductsService)
  private router = inject(Router)
  private route = inject(ActivatedRoute)

  ngOnInit() {
    this.productSvc.getProducts().subscribe((products) => this.products.set(products))
